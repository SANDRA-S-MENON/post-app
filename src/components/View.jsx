                        ...
                        <div className="row g-3">
                            {DataTransfer.map(
                                (value, index) =>{
                                    ...
                                    <div class="card">
                                        <img src="https://images.pexels.com/photos/1266810/pexels-photo-1266810.jpeg?cs=srgb&dl=pexels-8moments-1266810.jpg&fm=jpg" height="280px" class="card-img-top" alt="..."/>
                                            <div class="card-body">
